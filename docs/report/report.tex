...
\section{Limitations}
It was discovered that HTC's bluetooth stack does not support the L2Cap Bluetooth protocol which is used by the Wii Remote \cite{l2cap_htc}; The Android OS on the HTC Desire HD was altered to run with CyanogenMod 7 instead of the default HTC Sense.
