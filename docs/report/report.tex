...
The second part will be a quantitative study, where the viability of the system will be tested. It will be important to confirm that the system can perform the intended tasks and be reliable for several hours at a time.
