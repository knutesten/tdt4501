...
The primary research goal is to develop a mobile bio-feedback system through mass produced off the shelf products. A smartphone will function as the central hub for the system. Game controllers with motion detecting capabilities will be attached to the user in key locations and transmit sensor data to the smartphone. The phone will process and compute data. Interaction with the system will primarily be done through the smartphone. The system will provide the user with feedback through audio and vibration. The smarphone will be responsible for the audio feedback, while the game controller will provied feedback through vibration.
...
\item Perform tests to measure the durability of the system. Battery life, range and stability are factors that will affect the viability of the system.
